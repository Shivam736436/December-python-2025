...
# -----------------------------------------
# 6. Class variables (shared by all objects)
# -----------------------------------------
class Dog:
...
# -----------------------------------------
# 9. Encapsulation (private variables)
# -----------------------------------------
class BankAccount:
...
# -----------------------------------------
# 10. Polymorphism (same method, different objects)
# -----------------------------------------
class Cat:
    def speak(self):
        print("Meow!")
